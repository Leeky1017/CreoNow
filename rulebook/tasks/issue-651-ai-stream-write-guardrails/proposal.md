...
- 创建并维护 `rulebook/tasks/issue-651-ai-stream-write-guardrails/`（`proposal.md`、`tasks.md`、`.metadata.json`）。
...
- Affected code:
  - `rulebook/tasks/issue-651-ai-stream-write-guardrails/proposal.md`
  - `rulebook/tasks/issue-651-ai-stream-write-guardrails/tasks.md`
  - `rulebook/tasks/issue-651-ai-stream-write-guardrails/.metadata.json`
