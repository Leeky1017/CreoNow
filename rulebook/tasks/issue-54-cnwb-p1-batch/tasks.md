...
- [x] 1.1 Audit: P0 task cards vs merged PRs（回填 Status/Acceptance/Completion）
- [x] 1.2 P1-001: Light theme tokens + theme store + Settings AppearanceSection + E2E
- [x] 1.3 P1-002: Analytics/stats DB + main IPC/service + Analytics UI + E2E
