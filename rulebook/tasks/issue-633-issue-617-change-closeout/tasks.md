...
- [x] 2.1 Apply delta specs into main specs (`openspec/specs/**`)
- [x] 2.2 Tick change checklist + add evidence links (`openspec/changes/issue-617-scoped-lifecycle-and-abort/tasks.md`)
- [x] 2.3 Archive change to `openspec/changes/archive/issue-617-scoped-lifecycle-and-abort/`
- [x] 2.4 Sync `openspec/changes/EXECUTION_ORDER.md` (remove archived entry + 更新时间)

## 3. Delivery

- [x] 3.1 Update RUN_LOG with command outputs
- [x] 3.2 Create PR (body includes `Closes #633`) + enable auto-merge
