...
- 新增治理预检清单：`rulebook/tasks/issue-638-embedding-rag-offload/preflight-audit-checklist.md`，明确 BE-EMR-S1~S4 与门禁核验路径/通过标准。

## Impact

- Affected specs: `openspec/changes/issue-617-embedding-rag-offload/tasks.md`
- Affected docs: `rulebook/tasks/issue-638-embedding-rag-offload/preflight-audit-checklist.md`, `openspec/_ops/task_runs/ISSUE-638.md`
