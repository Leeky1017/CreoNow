...
### Requirement: Sprint3 Wave3 总控交付必须由主会话统一审计并收口

主会话 MUST 以单一总控分支集成 W3 全部子任务产出，并在合并前完成主会话审计、变更归档、执行顺序同步和门禁验证。

#### Scenario: W3 子任务全部纳入总控集成
...
- **Given** W3 3 个 change 的 tasks 全部勾选完成
- **When** 主会话准备提交集成分支
