...
const settingsTabs: TabItem[] = [
  {
    ...
    content: (
      <div>
        <h3 style={{ margin: "0 0 1rem", fontSize: "16px" }}>General Settings</h3>
...
const tabsWithDisabled: TabItem[] = [
  ...
  { value: "available", label: "Available", content: <div>Available tab content</div> },
  {
    value: "disabled",
    label: "Disabled",
    disabled: true,
  ...
  { value: "another", label: "Another", content: <div>Another tab content</div> },
];
...
export const LongLabels: Story = {
  args: {
    tabs: [
      { value: "t1", label: "Very Long Tab Label", content: <div>Content 1</div> },
      { value: "t2", label: "Another Long Label", content: <div>Content 2</div> },
    ...
    tabs: [
      {
        ...
        label: "Overview",
        content: (
          <div style={{ padding: "1rem", background: "var(--color-bg-surface)", borderRadius: "var(--radius-md)" }}>
            <h3 style={{ margin: "0 0 0.5rem", fontSize: "16px" }}>Project Overview</h3>
            <p style={{ margin: "0 0 1rem", color: "var(--color-fg-muted)", fontSize: "13px" }}>
              This is a comprehensive overview of your project.
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1rem" }}>
              <div style={{ padding: "1rem", background: "var(--color-bg-default)", borderRadius: "var(--radius-sm)" }}>
                <div style={{ fontSize: "24px", fontWeight: "600" }}>128</div>
                <div style={{ fontSize: "12px", color: "var(--color-fg-muted)" }}>Documents</div>
              </div>
              <div style={{ padding: "1rem", background: "var(--color-bg-default)", borderRadius: "var(--radius-sm)" }}>
                <div style={{ fontSize: "24px", fontWeight: "600" }}>45k</div>
                <div style={{ fontSize: "12px", color: "var(--color-fg-muted)" }}>Words</div>
              </div>
              <div style={{ padding: "1rem", background: "var(--color-bg-default)", borderRadius: "var(--radius-sm)" }}>
                <div style={{ fontSize: "24px", fontWeight: "600" }}>12</div>
                <div style={{ fontSize: "12px", color: "var(--color-fg-muted)" }}>Characters</div>
              </div>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div style={{ padding: "1rem" }}>
            ...
            <ul style={{ margin: 0, paddingLeft: "1.5rem", color: "var(--color-fg-muted)" }}>
...
export const SingleTab: Story = {
  args: {
    tabs: [{ value: "only", label: "Only Tab", content: <div>Single tab content</div> }],
  },
};
