...
describe("entity completion insertion", () => {
  it("S3-EC-S2 inserts canonical entity text and keeps typing continuity", async () => {
    ...
    const afterInsertText = editor.getText();

    act(() => {
      editor.commands.insertContent("more");
    });

    expect(editor.getText()).toBe(`${afterInsertText}more`);
  });
});
