// TODO [Phase 2]: 接入 ragService + queryPlanner 替换当前手工 hybrid 路径
// 当前主链：ipc/rag.ts 直接做 semantic + FTS + hybrid rerank
// 目标：改为调用 createRagService() → ragService.retrieve()
// 条件：当内容量增大、需要跨文档/跨项目检索时
