> ⚠️ **部分过时**：本文件中的架构设计理念仍有参考价值，但具体技术栈版本和 SSOT 链接已过时。当前前端架构以 `AGENTS.md` P-V 章节和 `docs/references/frontend-visual-quality.md` 为准。

---

# CreoNow 新前端架构设计

> ~~📂 SSOT 文件夹入口：docs/cn-frontend-ssot/README.md~~ （已失效，原目录不存在）
