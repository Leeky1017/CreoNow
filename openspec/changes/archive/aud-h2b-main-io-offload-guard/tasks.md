...
- RUN_LOG：`openspec/_ops/task_runs/ISSUE-591.md`
  - Red/Green：见 `## Runs`（Targeted Regression Pack / Wave1 Verification Gates）
...
- 输入：`openspec/changes/aud-h2a-main-hotpath-async-io/specs/context-engine/spec.md`、`apps/desktop/main/src/services/context/contextFs.ts`
