...
5. Phase E（并行）
   ...
   - `search-retrieval-p4-hardening-boundary`（依赖 `search-retrieval-p1-embedding-semantic-rag` + `search-retrieval-p2-replace-versioned` + `search-retrieval-p3-hybrid-ranking-explain`）
