...
- `openspec/changes/document-management-p2-hardening-and-gates/proposal.md`
- `openspec/changes/document-management-p2-hardening-and-gates/tasks.md`
- `openspec/changes/document-management-p2-hardening-and-gates/specs/document-management/spec.md`
- `openspec/changes/EXECUTION_ORDER.md`（活跃 change 数量 >= 2）
